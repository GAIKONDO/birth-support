...
const ChildcareShortTimeWorkDetail = () => {
  ...
  const architectureDiagram = `
    graph TB
      ...
      subgraph areaA[" "]
        A["👤 あなた<br/>（被保険者）"]
        A_DESC["育児のために短時間勤務を選択し給付金を受給する当事者"]
      end
      
      subgraph areaB[" "]
        B["🏢 ハローワーク"]
        B_DESC["雇用保険の給付を行う機関。育児時短就業給付金を支給"]
      end
      
      D -->|"1. 制度設計・監督<br/>（事務処理）"| B
      E -->|"2. 雇用保険の加入手続き<br/>（事務処理）"| B
      A -->|"3. 雇用保険に加入<br/>（加入）"| B
      A -->|"4. 短時間勤務の申請<br/>（申請）"| E
      E -->|"5. 給付金の申請を代行<br/>（申請代行）"| B
      B -->|"6. 育児時短就業給付金を支給<br/>（支給）"| A
  ...
  const componentDiagram = `
    graph LR
      ...
      C --> C1[詳細はこども家庭庁の<br/>公式サイトを確認]
      
      D --> D1[育児のために短時間勤務を<br/>選択している期間]
        ...
        <div className="detail-section mermaid-section">
          ...
          <div className="detail-card" ref={fullscreenRef}>
            ...
            {viewMode === 'correlation' && (
              <>
                <p className="section-description">
                  育児時短就業給付金制度に関わる主要な組織とその関係性を示します。<strong className="highlight-text">紫色の枠で囲まれた「あなた」が当事者（被保険者）の位置</strong>です。図中の数字は手続きの流れを示しています。
                </p>
                <div className="mermaid-container">
                  <MermaidChart chart={architectureDiagram} id="childcare-short-time-work-correlation" zoomLevel={zoomLevel} />
                </div>
                <div className="diagram-legend">
                  <h4 className="legend-title">図の見方</h4>
                  <ul className="legend-list">
                    <li><strong className="legend-you">👤 あなた（被保険者）</strong>：育児のために短時間勤務を選択し、育児時短就業給付金を受給する当事者です。雇用保険に加入している方が対象です。</li>
                    <li><strong>🏢 ハローワーク</strong>：雇用保険の給付を行う機関です。育児時短就業給付金の支給を行います。</li>
                    <li><strong>💼 勤務先</strong>：雇用主です。育児時短就業給付金の申請手続きを代行します。</li>
            ...
            {viewMode === 'components' && (
              <>
                <p className="section-description">
                  育児時短就業給付金制度の構成要素を樹形図で示します。
                </p>
                <div className="mermaid-container">
                  <MermaidChart chart={componentDiagram} id="childcare-short-time-work-component" zoomLevel={zoomLevel} />
                </div>
              </>
            )}
            ...
            {viewMode === 'flow' && (
              <>
                <p className="section-description">
                  育児時短就業給付金の申請フローを示します。
                  <br />
                  <span style={{ fontSize: '13px', color: '#dc2626', fontStyle: 'italic' }}>
                    ※この制度は令和7年4月1日から創設されます。育児のために短時間勤務を選択した場合に支給されます。詳細はこども家庭庁の公式サイトで最新情報を確認してください。
                  </span>
                </p>
                <div className="mermaid-container">
                  <MermaidChart chart={applicationFlowSequence} id="childcare-short-time-work-flow" zoomLevel={zoomLevel} />
                </div>
                <div className="flow-explanation" style={{ marginTop: '24px', padding: '16px', backgroundColor: '#f9fafb', borderRadius: '8px', fontSize: '14px', lineHeight: '1.6' }}>
                  ...
                  <p style={{ margin: 0, marginBottom: '24px', color: '#6b7280' }}>
                    ハローワーク（正式名称：公共職業安定所）は、日本政府（厚生労働省）が運営する公的な就業支援機関です。育児時短就業給付金の申請においては、雇用保険の給付を行う機関として、申請書類の審査や給付金の支給を行います。
                  </p>
                  ...
                  <ol style={{ margin: 0, paddingLeft: '20px', color: '#6b7280' }}>
                    <li style={{ marginBottom: '12px' }}>
                      <strong style={{ color: '#374151' }}>育児のための短時間勤務の申請</strong><br />
                      被保険者が勤務先に育児のために短時間勤務を選択する意思を伝えます。短時間勤務の開始予定日や終了予定日を明確にすることが重要です。
                    </li>
                    <li style={{ marginBottom: '12px' }}>
                    ...
                    <li style={{ marginBottom: '12px' }}>
                      ...
                      勤務先が申請に必要な書類を作成します。受給資格確認票や育児時短就業給付金支給申請書などを作成し、被保険者の情報を記入します。
                    </li>
                    <li style={{ marginBottom: '12px' }}>
                    ...
                    <li style={{ marginBottom: '12px' }}>
                      ...
                      ハローワークが被保険者の指定口座に給付金を振り込みます。給付金額の詳細はこども家庭庁の公式サイトで最新情報を確認してください。
                    </li>
          ...
          <div className="detail-card">
            <table className="overview-table">
              <tbody>
                <tr>
                  <th>概要</th>
                  <td>育児のために短時間勤務を選択した場合に支給される給付金です。</td>
                </tr>
                <tr>
                  <th>支給金額</th>
                  <td>
                    <span className="amount-highlight-inline">詳細はこども家庭庁の公式サイトを確認</span>
                  </td>
                </tr>
                <tr>
                  <th>対象者</th>
...
export default ChildcareShortTimeWorkDetail;
